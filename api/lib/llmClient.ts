  ...
  async generateAnswer(
    ...
    try {
      ...
      userMessageParts.push(
        ...
        "Include document citations [doc_id] for key claims.",
        conversationHistory
        ...
        messages: [
          {
            ...
            content: [
              ...
              "2. **Citation Discipline**: Cite document IDs in square brackets [doc_id] after each claim.",
              ...
              "- Include document citations inline",
